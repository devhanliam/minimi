...
public class EntityCovertLayeredFormHelper<K,E,D> {
    ...
    public static <K, E, D> EntityCovertLayeredFormHelper newInstance(List<E> entities, Function<E, D> toDto, Function<E, E> getParent, Function<E, K> getKey, Function<D, List<D>> getChildren) {
        return new EntityCovertLayeredFormHelper<K, E, D>(entities, toDto, getParent, getKey, getChildren);
    }

    private EntityCovertLayeredFormHelper(List<E> entities, Function<E, D> toDto, Function<E, E> getParent, Function<E, K> getKey, Function<D, List<D>> getChildren) {
